...
kubectl apply --filename https://github.com/knative/net-contour/releases/download/v0.16.0/contour.yaml

# Install the Knative Contour controller
kubectl apply --filename https://github.com/knative/net-contour/releases/download/v0.16.0/net-contour.yaml
