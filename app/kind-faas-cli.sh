...
# Add 127.0.0.1 gateway.openfaas.local to /etc/hosts to map the default host entry for OpenFaaS ingress
 # see the OpenFaaS UI
 # http://gateway.openfaas.local:30080/ui/
...
interact with the function with the OpenFaaS UI at
curl http://gateway.openfaas.local:30080/ui/
